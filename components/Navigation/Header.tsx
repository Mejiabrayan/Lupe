...
export function Header() {
  ...
  return (
    ...
    >
      <nav className='border border-border px-4 flex items-center backdrop-filter backdrop-blur-xl bg-[#121212] bg-opacity-70 h-[50px]  rounded-xl'>
        <ContextMenu>
          <ContextMenuTrigger>
            <Link href='/'>
              <span className='sr-only'>Lupe Logo</span>
              Lupe.
            </Link>
          </ContextMenuTrigger>
