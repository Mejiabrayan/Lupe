    ...
    <section className="py-8 px-4 md:py-16 md:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
        <div className="md:col-span-1 mb-8 md:mb-0">
          <p className="text-xl font-thin text-primary-accent w-1/2">Who we are</p>
        </div>
        <div className="md:col-span-2">
          <h3 className="text-xl text-wrap md:text-2xl lg:text-3xl text-medium text-black dark:text-white leading-loose">
